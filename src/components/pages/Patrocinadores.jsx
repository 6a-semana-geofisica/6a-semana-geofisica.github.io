...
// Arreglos de configuración de logos (puedes usar .svg, .png, .jpg, etc.)
const logoOrganiza = {
  id: 'uis',
  nombre: 'Universidad Industrial de Santander',
  src: 'src/assets/organizaciones/logo_UIS.png',
  alt: 'Logo UIS'
};

const logosApoyan = [
  { id: 1, nombre: 'Apoyo 1', src: 'src/assets/organizaciones/hdsplogo.svg', alt: 'Logo Apoyo 1' }, 
  { id: 2, nombre: 'Apoyo 2', src: 'src/assets/organizaciones/gigba_logo.png', alt: 'Logo Apoyo 2' }, 
  { id: 3, nombre: 'Apoyo 3', src: 'src/assets/organizaciones/gidco.png', alt: 'Logo Apoyo 3' },
  { id: 4, nombre: 'Apoyo 4', src: 'src/assets/organizaciones/logo_SIGAC_2024.png', alt: 'Logo Apoyo 4' },
];

const logosFinancian = [
  { id: 1, nombre: 'Financia 1', src: 'src/assets/organizaciones/logo_minciencias.png', alt: 'Logo Financia 1' },
  { id: 2, nombre: 'Financia 2', src: 'src/assets/organizaciones/LOGO_ANH.png', alt: 'Logo Financia 2' },
];
      ...
      <section className="bg-slate-50/50 px-4 py-16 sm:px-6 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-24 flex flex-col items-center justify-center text-center">
            ...
            <p className="mb-16 font-['Montserrat'] text-base leading-relaxed text-slate-600 md:text-lg max-w-4xl">
            ...
            <div className="w-full max-w-5xl">
              ...
              <div className="mb-14 flex flex-col items-center">
                ...
                <div className="group flex h-32 w-72 items-center justify-center p-2 cursor-pointer transition-all duration-300 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 hover:scale-105">
                  <img 
                    src={logoOrganiza.src} 
                    alt={logoOrganiza.alt} 
                    className="max-h-full max-w-full object-contain"
                  />
                </div>
              </div>

              <div className="mx-auto mb-14 h-px w-2/3 bg-gradient-to-r from-transparent via-slate-300 to-transparent"></div>
              ...
              <div className="mb-14 flex flex-col items-center">
                ...
                <div className="flex flex-wrap items-center justify-center gap-8 md:gap-14">
                  {logosApoyan.map((logo) => (
                    /* Contenedor ajustado a h-28 w-52 */
                    <div 
                      key={logo.id} 
                      className="group flex h-28 w-52 items-center justify-center p-2 cursor-pointer transition-all duration-300 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 hover:scale-105"
                    >
                      <img 
                        src={logo.src} 
                        alt={logo.alt} 
