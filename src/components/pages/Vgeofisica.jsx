...
// TODO: Reemplaza estas rutas con las fotos reales del evento tomadas con cámara
import Foto1 from '../../assets/evento/v_semana_2025_conferencia_1.jpg'
import Foto2 from '../../assets/evento/v_semana_2025_conferencia_2.jpg'
import Foto3 from '../../assets/evento/v_semana_2025_conferencia_4.jpg'
  ...
  return (
    <div>
      <Hero titulo={tituloVgeofisica}>
        <Button
          className="mr-12 w-full sm:w-auto"
      ...
      {/* SECCIÓN DE CONTENIDO: 2 Columnas (Texto | Fotos) */}
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
            ...
            <div className="flex flex-col space-y-16 lg:col-span-7">
              ...
              {/* Bloque 0: Introducción (antes centrada, ahora parte de la columna) */}
              <div>
                <div className="mb-6 flex items-center gap-4">
                  <div className="h-[2px] w-12 bg-gradient-to-r from-transparent to-gold-400"></div>
                  <h2 className="font-['Montserrat'] text-2xl font-bold uppercase tracking-widest text-slate-900 sm:text-3xl">
              ...
              {/* Bloque 1: Un encuentro para las geociencias */}
              <div>
                <div className="mb-6 flex items-center gap-4">
              ...
              {/* Bloque 2: Cinco días de aprendizaje */}
              <div>
                <div className="mb-6 flex items-center gap-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="flex gap-3 rounded-xl border border-slate-100 bg-white p-4 shadow-sm transition-shadow hover:shadow-md">
                    ...
                    <span className="text-sm font-medium text-slate-700">Conferencias magistrales con expertos nacionales e internacionales.</span>
                  </div>
                  <div className="flex gap-3 rounded-xl border border-slate-100 bg-white p-4 shadow-sm transition-shadow hover:shadow-md">
                    <svg className="h-6 w-6 shrink-0 text-brand-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M19.114 5.636a9 9 0 010 12.728M16.463 8.288a5.25 5.25 0 010 7.424M6.75 8.25l4.72-4.72a.75.75 0 011.28.53v15.88a.75.75 0 01-1.28.53l-4.72-4.72H4.51c-.88 0-1.704-.507-1.938-1.354A9.01 9.01 0 012.25 12c0-.83.112-1.633.322-2.396C2.806 8.756 3.63 8.25 4.51 8.25H6.75z" />
                    </svg>
                    <span className="text-sm font-medium text-slate-700">Presentaciones orales de investigaciones y avances científicos.</span>
                  </div>
                  <div className="flex gap-3 rounded-xl border border-slate-100 bg-white p-4 shadow-sm transition-shadow hover:shadow-md">
                    <svg className="h-6 w-6 shrink-0 text-brand-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />
                    </svg>
                    <span className="text-sm font-medium text-slate-700">Sesiones de pósteres para divulgar resultados y recibir retroalimentación.</span>
                  </div>
                  <div className="flex gap-3 rounded-xl border border-slate-100 bg-white p-4 shadow-sm transition-shadow hover:shadow-md">
                    <svg className="h-6 w-6 shrink-0 text-brand-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    ...
                    <span className="text-sm font-medium text-slate-700">Un reto académico orientado a la creatividad y la solución de problemas.</span>
                  </div>
                  <div className="flex gap-3 rounded-xl border border-slate-100 bg-white p-4 shadow-sm transition-shadow hover:shadow-md sm:col-span-2">
                    <svg className="h-6 w-6 shrink-0 text-brand-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 01-.982-3.172M9.497 14.25a7.454 7.454 0 00.981-3.172M5.25 4.236c-.982.143-1.954.317-2.916.52A6.003 6.003 0 007.73 9.728M18.75 4.236c.982.143 1.954.317 2.916.52a6.003 6.003 0 01-5.395 4.972m0 0a8.001 8.001 0 00-1.718-7.794m1.718 7.794a8.001 8.001 0 01-1.718 7.794M7.73 9.728A8.001 8.001 0 006.012 1.934m1.718 7.794a8.001 8.001 0 011.718 7.794" />
                    </svg>
                    <span className="text-sm font-medium text-slate-700">Reconocimientos para los trabajos y propuestas más destacadas.</span>
                  </div>
                </div>
              </div>

              {/* Bloque 3: Conexiones y experiencias */}
              <div>
                <div className="mb-6 flex items-center gap-4">
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-brand-50 text-brand-600 shadow-sm">
                    <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                ...
                <ul className="grid gap-4 sm:grid-cols-2">
                  <li className="flex gap-3 rounded-xl border border-slate-100 bg-white p-4 shadow-sm transition-shadow hover:shadow-md">
                    <svg className="h-6 w-6 shrink-0 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244" />
                    </svg>
                    <span className="text-sm font-medium text-slate-700">Crear nuevas redes de colaboración.</span>
                  </li>
                  <li className="flex gap-3 rounded-xl border border-slate-100 bg-white p-4 shadow-sm transition-shadow hover:shadow-md">
                    <svg className="h-6 w-6 shrink-0 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
                    </svg>
                    <span className="text-sm font-medium text-slate-700">Intercambiar conocimientos y experiencias.</span>
                  </li>
                  <li className="flex gap-3 rounded-xl border border-slate-100 bg-white p-4 shadow-sm transition-shadow hover:shadow-md">
                    <svg className="h-6 w-6 shrink-0 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                    </svg>
                    <span className="text-sm font-medium text-slate-700">Conocer oportunidades académicas y de investigación.</span>
                  </li>
                  <li className="flex gap-3 rounded-xl border border-slate-100 bg-white p-4 shadow-sm transition-shadow hover:shadow-md">
                    <svg className="h-6 w-6 shrink-0 text-gold-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.631 8.41m5.96 5.96a14.926 14.926 0 01-5.841 2.58m-.119-8.54a6 6 0 00-7.381 5.84h4.8m2.581-5.84a14.927 14.927 0 00-2.58 5.841m2.699 2.7c-.103.021-.207.041-.311.06a15.09 15.09 0 01-2.448-2.448 14.9 14.9 0 01.06-.312m-2.24 2.39a4.493 4.493 0 00-1.757 4.306 4.493 4.493 0 004.306-1.758M16.5 9a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
                    </svg>
                    <span className="text-sm font-medium text-slate-700">Inspirar a nuevas generaciones de geocientíficos.</span>
                  </li>
                </ul>
              </div>
            ...
            {/* COLUMNA DERECHA: Fotos apiladas, todas del mismo tamaño (Sticky) */}
            <div className="lg:sticky lg:top-24 lg:col-span-5">
              <div className="space-y-4">
                <div className="group relative aspect-[4/3] overflow-hidden rounded-2xl border border-slate-100 shadow-lg">
                  <img
                    src={Foto1}
                    alt="Momento destacado de la V Semana de la Geofísica"
                ...
                <div className="group relative aspect-[4/3] overflow-hidden rounded-2xl border border-slate-100 shadow-lg">
                  <img
                    src={Foto2}
                    alt="Asistentes de la V Semana de la Geofísica"
                    className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105"
                  />
                </div>
                <div className="group relative aspect-[4/3] overflow-hidden rounded-2xl border border-slate-100 shadow-lg">
                  <img
                    src={Foto3}
                    alt="Actividades de la V Semana de la Geofísica"
                    className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105"
                  />
                </div>
              </div>
